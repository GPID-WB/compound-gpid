...
3. Read `.claude/shared/review-routing.contract.md`; it is the canonical source for staged review modes, risk classes, precedence, and additive dedup.
...
Use deterministic preflight routing from `.claude/shared/review-routing.contract.md`:
...
Based on the resolved staged mode from Step 1.5 and `.claude/shared/review-routing.contract.md`, invoke only the route-appropriate agents on the changed files:
...
Read `.claude/shared/model-advisory.contract.md` and use the `review` stage for

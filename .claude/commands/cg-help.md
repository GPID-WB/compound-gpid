...
1. `cg-help --prepare-request --root . --platform claude-code`
2. Write the query through the validated `queryPath` using a structured file-write tool.
3. `cg-help --consume-request <uuid> --root . --platform claude-code`
...
5. `cg-help --render-selection <uuid> --root . --platform claude-code`

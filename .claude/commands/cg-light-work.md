...
`.claude/shared/context-loading.contract.md`. Before questions, inspect the
...
in `.claude/shared/review-routing.contract.md` for H2-H5. Any hard gate or a
...
completion contract. Load `.claude/shared/artifact-view.contract.md`; run
...
Load `.claude/shared/goal-execution.contract.md` and
`.claude/shared/active-state.contract.md`. Create and Plan-link a standard Work
...
Resolve `light` through `.claude/shared/review-routing.contract.md`. For the
...
Read `.claude/shared/model-advisory.contract.md` only for the compact completion

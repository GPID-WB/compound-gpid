...
`.claude/shared/goal-execution.contract.md`,
`.claude/shared/active-state.contract.md`,
`.claude/shared/context-loading.contract.md` and
`.claude/shared/review-routing.contract.md` at their workflow boundaries.

...
- Total files: 90
- Total characters: 1761521
- Total estimated tokens: 440352
...
| shared | 6 | 33456 | 8362 |
| template | 1 | 1633 | 408 |
| docs | 10 | 210666 | 52663 |
| brain | 4 | 285367 | 71341 |
| brain_index | 1 | 631420 | 157855 |
| context | 1 | 64564 | 16141 |
| roadmap | 1 | 67082 | 16770 |

## Top 15 Largest Files

| Path | Category | Characters | Estimated Tokens |
| --- | --- | --- | --- |
| .cg-docs/brain-index.json | brain_index | 631420 | 157855 |
| .cg-docs/BRAIN-log.md | brain | 149084 | 37271 |
| .cg-docs/BRAIN-01.md | brain | 113751 | 28437 |
| docs/workflow.md | docs | 67269 | 16817 |
| roadmap.json | roadmap | 67082 | 16770 |
| compound-gpid.context.md | context | 64564 | 16141 |
| docs/reference.md | docs | 48697 | 12174 |
...
| --- | --- | --- | --- | --- |
| medium | project-context | Use query-first project context. | context=16141, brain=71341, brain_index=157855 estimated tokens. | Use the Brain meta-index and targeted sections; avoid loading full context, Brain partitions, or brain-index records by default. |
| low | documentation | Treat docs size as opt-in cost. | docs category is estimated at 52663 tokens. | Do not optimize docs for runtime unless prompts or skills load them automatically. |
...
| risk | docs/reference.md | 158 | .cg-docs/ | broad context-loading instruction | \| `.cg-docs/token/context-map.json` \| Workflow-to-context map of deterministic file, skill, agent, tool, and context-loading signals \| |
...
| justified | docs/reference.md | 76 | BRAIN.md | maintenance/tooling workflow | \| `/cg-brain-rebuild` \| GPT-5.4 \| Rebuild the project knowledge brain (`BRAIN.md` + `BRAIN-NN.md` partitions + `BRAIN-log.md` + `brain-index.json`) by running `cg-index --brain`. Use directly after pulling `.cg-docs/` ch |
| justified | docs/reference.md | 82 | roadmap.json | maintenance/tooling workflow | \| `/cg-issues [status\\|backfill\\|link\\|adopt\\|setup]` \| Claude Haiku 4.5 \| Manage GitHub Issues linked to roadmap work items. `status` (default, read-only): display linked issues and unlinked features. `backfill`: create |
| justified | docs/reference.md | 149 | .cg-docs/ | maintenance/tooling workflow | Use `--baseline` with a previous `context-audit.json` to render before/after benchmark deltas. Use `--recommendations` to also write `.cg-docs/cost/token-advice.md`, a compact advisory report with fix/accept/docs-only wa |

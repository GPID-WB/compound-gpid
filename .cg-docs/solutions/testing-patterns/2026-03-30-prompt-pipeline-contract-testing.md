...
- [2026-04-15-pester-dotall-flag-required-for-multiline-regex.md](./2026-04-15-pester-dotall-flag-required-for-multiline-regex.md) — Pester regex without `(?s)` gives silent false-negative when matched text spans a line break
- [2026-04-15-loop-early-exit-skips-per-iteration-cleanup.md](../bugs/2026-04-15-loop-early-exit-skips-per-iteration-cleanup.md) — prompt loop early-exit directive bypasses per-iteration cleanup steps
- [2026-05-06-cross-prompt-user-journey-must-be-validated-end-to-end.md](./2026-05-06-cross-prompt-user-journey-must-be-validated-end-to-end.md) — **behavioral journey contracts** (complementary): when prompt A says "run /cg-X next", verify that X doesn't halt in the state A implies. This file covers data/format contracts; the journey doc covers behavioral ones.

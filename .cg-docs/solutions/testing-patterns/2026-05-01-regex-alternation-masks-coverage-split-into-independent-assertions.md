...
- `.cg-docs/solutions/testing-patterns/2026-06-12-regex-arm-dead-from-inception-typo-passes-via-sibling.md` — third variant: arm dead from inception due to typo (e.g., `fall back` vs `falls back`); no refactoring involved
- `.cg-docs/solutions/testing-patterns/2026-07-24-cross-file-contract-state-must-align-docs-validator-tests.md` — same session pattern at a broader scope: independent assertions in prompt-tools helped surface a real cross-file contract drift instead of masking it

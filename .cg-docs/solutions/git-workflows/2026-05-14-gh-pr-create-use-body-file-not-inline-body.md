...
- `.cg-docs/solutions/git-workflows/2026-09-17-repo-settings-auto-merge-protect-dev-required-checks.md` — settings verification prerequisite for automated PR merges

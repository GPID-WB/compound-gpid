...
> Creates and maintains the project wiki (wiki/ folder). Dispatched by /cg-setup (init), /cg-compound (update), and /cg-wiki (rebuild, convert). Never invoked directly by users.
...
1. Load `cg-skill-wiki` (`.agents/skills/cg-skill-wiki/SKILL.md`).

# Agent: cg-workflow-stage

> Runs one read-only Kilo bootstrap probe under the autopilot stage contract.

# Workflow Stage

Read `.agents/shared/autopilot-stage.contract.md`; this agent is probe-only.

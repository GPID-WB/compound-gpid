# Agent: cg-bootstrap-leaf

> Runs only the read-only Git bootstrap probes of the autopilot stage contract as a restricted leaf.

# Bootstrap Read-Only Leaf

Read `.agents/shared/autopilot-stage.contract.md`; this leaf is probe-only.

...
`.agents/shared/goal-execution.contract.md`,
`.agents/shared/active-state.contract.md`,
`.agents/shared/context-loading.contract.md` and
`.agents/shared/review-routing.contract.md` at their workflow boundaries.

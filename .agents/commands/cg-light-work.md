...
`.agents/shared/context-loading.contract.md`. Before questions, inspect the
...
in `.agents/shared/review-routing.contract.md` for H2-H5. Any hard gate or a
...
completion contract. Load `.agents/shared/artifact-view.contract.md`; run
...
Load `.agents/shared/goal-execution.contract.md` and
`.agents/shared/active-state.contract.md`. Create and Plan-link a standard Work
...
Resolve `light` through `.agents/shared/review-routing.contract.md`. For the
...
Read `.agents/shared/model-advisory.contract.md` only for the compact completion

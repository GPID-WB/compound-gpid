...
|------|----------|----------|-------------|
| `.claude/` | Claude Code | Commands, skills, agents, `CLAUDE.md`, model mapping | `cg_generate_targets.py --target claude-code` |
| `.agents/` | Codex | Commands, subagent TOMLs, fallback skills, `AGENTS.md`, model mapping | `cg_generate_targets.py --target codex` |
| `.opencode/` | OpenCode | Commands, skills, agents, `AGENTS.md`, config, model mapping | `cg_generate_targets.py --target opencode` |

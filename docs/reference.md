...
│   ├── hooks/                # PowerShell scripts invoked by the VS Code Copilot agent hooks API
│   │                         # (Phase 0 PoC — subject to change after validation; not distributed
│   │                         #  via cg-link junctions until Phase 0 completes)

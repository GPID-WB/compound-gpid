...
| `cg-brain-rebuild.prompt.md` | Claude Sonnet 4.6 | Rebuild the project knowledge brain via `cg-index --brain` | Orchestration 2, precision 3 — single-tool invocation with tiered verification; Sonnet appropriate | confirmed |

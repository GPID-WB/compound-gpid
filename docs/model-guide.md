...
Reference for model assignments across all 31 Compound GPID prompt and agent files.
...
files" and "Model assignments — agent files" describe blocks) validate all 31 files for model:

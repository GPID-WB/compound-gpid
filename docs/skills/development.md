...
| `cg-skill-management` | Descriptor-driven discovery, import, activation, update, audit, and retirement workflows | Used by the public `/cg-skill` lifecycle command | Public with the `cg` suite | [Canonical source](https://github.com/GPID-WB/compound-gpid/blob/main/.github/skills/cg-skill-management/SKILL.md) |

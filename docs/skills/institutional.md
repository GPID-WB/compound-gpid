...
These skills help teams make decisions, retain verified knowledge, present
dense material clearly, write source-grounded institutional documents, and
...
| `cg-skill-standalone-html-brief` | Self-contained editorial HTML briefs with source-fidelity, comparison, responsive, accessibility, and print contracts | Turning brainstorms, plans, reviews, architecture decisions, strategies, or methodology notes into human-readable visual explainers | Broad; output-conditional | [Canonical source](https://github.com/GPID-WB/compound-gpid/blob/main/.github/skills/cg-skill-standalone-html-brief/SKILL.md) |
...
The standalone HTML brief skill presents an existing source more clearly. It
does not authorize new facts, decisions, metrics, citations, or institutional
positions. The source document remains authoritative; the HTML file is a
portable explanatory view.

...
| `cg-skill-render-doc` | Curated HTML publishing for typed workflow artifacts and generic Markdown, with explicit reference/editorial themes | Rendering, validating, or checking freshness of project documents | Broad; publishing-conditional | [Canonical source](https://github.com/GPID-WB/compound-gpid/blob/main/.github/skills/cg-skill-render-doc/SKILL.md) |

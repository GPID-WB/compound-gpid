...
1. `cg-help --prepare-request --root . --platform opencode`
2. Write the query through the validated `queryPath` using a structured file-write tool.
3. `cg-help --consume-request <uuid> --root . --platform opencode`
...
5. `cg-help --render-selection <uuid> --root . --platform opencode`

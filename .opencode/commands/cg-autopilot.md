...
`.opencode/shared/autopilot-stage.contract.md` before action. Apply its authority,
...
specified in `.opencode/shared/autopilot-stage.contract.md` and documented in

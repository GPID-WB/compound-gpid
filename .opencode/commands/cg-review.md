...
Use deterministic preflight routing from `.opencode/shared/review-routing.contract.md`:
...
Based on the resolved staged mode from Step 1.5 and `.opencode/shared/review-routing.contract.md`, invoke only the route-appropriate agents on the changed files:

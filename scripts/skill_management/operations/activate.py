"""Explicit capability activation operation."""
...
def handle(*, context: Any, request: Mapping[str, Any]) -> OperationOutcome:
    """Plan or apply one explicit capability activation."""
    return handle_change(context=context, request=request, activate=True)

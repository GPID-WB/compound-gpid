...
- Stata: Master do-file structure, subordinate do-file organization, `code/ado/` package management, `repado`. Load `cg-skill-stata-core` before reviewing any `.do` or `.ado` file.

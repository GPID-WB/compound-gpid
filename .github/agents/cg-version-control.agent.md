...
- R/Python/Stata: language-specific gitignore patterns, lockfile management. For R files, load `cg-skill-r-technical` to verify renv and lockfile conventions. For Stata files, load `cg-skill-stata-core` to verify `repado` and do-file conventions.

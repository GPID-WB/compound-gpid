...
description: >
  ...
  Load when writing, reviewing, or debugging test blocks in .do/.ado files.
...
| [`references/reproducibility-reprun.md`](references/reproducibility-reprun.md) | `reprun`, `reproot`, `repscan`, `set seed`, result caching, reproducibility failures |
...
| [`references/anti-patterns.md`](references/anti-patterns.md) | 8 testing-specific anti-patterns with ❌ wrong / ✅ correct patterns and explanations |

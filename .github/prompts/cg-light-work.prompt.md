...
`.github/shared/context-loading.contract.md`. Before questions, inspect the
...
in `.github/shared/review-routing.contract.md` for H2-H5. Any hard gate or a
...
completion contract. Load `.github/shared/artifact-view.contract.md`; run
...
Load `.github/shared/goal-execution.contract.md` and
`.github/shared/active-state.contract.md`. Create and Plan-link a standard Work
...
Resolve `light` through `.github/shared/review-routing.contract.md`. For the
...
Read `.github/shared/model-advisory.contract.md` only for the compact completion

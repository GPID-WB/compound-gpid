...
`.kilo/shared/goal-execution.contract.md`,
`.kilo/shared/active-state.contract.md`,
`.kilo/shared/context-loading.contract.md` and
`.kilo/shared/review-routing.contract.md` at their workflow boundaries.

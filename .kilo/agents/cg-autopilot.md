---
description: "Coordinates read-only Kilo autopilot bootstrap probes without executing workflow stages."
mode: primary
permission: {"*": "deny", "cg_native_evidence": "ask", "cg_native_identity": "ask", "glob": "allow", "grep": "allow", "read": "allow", "task": {"*": "ask", "cg-workflow-stage": "allow"}}
---

# Autopilot Parent

Read `.kilo/shared/autopilot-stage.contract.md` and follow its probe-only

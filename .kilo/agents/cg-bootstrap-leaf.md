...
mode: subagent
permission: {"*": "deny", "bash": {"*": "deny", "git branch --show-current*": "allow", "git rev-parse*": "allow", "git status --porcelain*": "allow"}, "cg_native_identity": "ask", "glob": "allow", "grep": "allow", "read": "allow"}
---

# Bootstrap Read-Only Leaf

Read `.kilo/shared/autopilot-stage.contract.md`; this leaf is probe-only.

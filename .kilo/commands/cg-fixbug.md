...
2. Read `compound-gpid.local.md` for user config (language, project type,
   review depth).
3. Load `.kilo/shared/context-loading.contract.md`. Search targeted headings
...
1. Implement the fix based on the confirmed diagnosis. Follow project conventions:
   - R: follow `.kilo/instructions/r.instructions.md` style.
   - Python: follow `.kilo/instructions/python.instructions.md` style.
   - Stata: follow `.kilo/instructions/stata.instructions.md` style and load `cg-skill-stata-best-practices`.

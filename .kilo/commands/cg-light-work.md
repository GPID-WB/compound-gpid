...
`.kilo/shared/context-loading.contract.md`. Before questions, inspect the
...
in `.kilo/shared/review-routing.contract.md` for H2-H5. Any hard gate or a
...
completion contract. Load `.kilo/shared/artifact-view.contract.md`; run
...
Load `.kilo/shared/goal-execution.contract.md` and
`.kilo/shared/active-state.contract.md`. Create and Plan-link a standard Work
...
Resolve `light` through `.kilo/shared/review-routing.contract.md`. For the
...
Read `.kilo/shared/model-advisory.contract.md` only for the compact completion
